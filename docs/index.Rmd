...
mulnutrition_data
```
This table contains general summary information about this data collection on malnourished children, including the regions we chose to analyze, income levels, the number and percentage of the three types of malnourished children, and the years in which these data were collected. The purpose of this table is not only to allow us to more clearly filter the data we need, but also to be able to more clearly present our data to our audience so they can better understand our project. The region we chose was the WHO region because we thought it would be more clearly divided and easier to analyze. We chose low-income, middle-income, lower-middle-income, upper-middle-income and high-income to facilitate our analysis of the impact of different incomes on child malnutrition.
