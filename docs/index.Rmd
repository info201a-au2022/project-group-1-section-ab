...
The project reports current relevant information on child malnutrition from 2010 to 2020. To have a more comprehensive analysis, we have 12 observations in total in exploring child malnutrition situations among different regions and how it can be affected by different household incomes. The 8 variables we have for the report are prevalence and number of three different types of malnutrition along with the influential factor region and year. South-East Asia has the highest prevalence of stunting, 41.6%. Europe has the highest prevalence of overweight, and the number is 9.8%. South-East Asia also has the highest prevalence of wasting, which is 14.5%.
